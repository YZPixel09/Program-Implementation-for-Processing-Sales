...
public class ItemTest {
    ...
    public void testIncreaseQuantityWithMaxValue() {
       ...
       int expectedQuantity = Integer.MAX_VALUE; // Adding a value to max value should not overflow
        item.increaseQuantity(maxValue);

        // Assert
        assertEquals(expectedQuantity, item.getQuantity(), "Quantity should not overflow when adding to max int value");
    }
}
